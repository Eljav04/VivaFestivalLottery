...
import { Power, UserPlus, List, CheckCircle2, Smartphone, User } from 'lucide-react';
...
const CheckInPage = () => {
    const { participants, addParticipant } = useLotteryStore();
                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-2">
                        <div className="flex items-baseline gap-4 flex-1">
                            <h2 className="text-4xl md:text-6xl font-headline font-black tracking-tighter uppercase leading-none">
                                QEYDİYYAT <span className="text-primary">PANELİ</span>
                            </h2>
                            <div className="h-[2px] flex-1 bg-linear-to-r from-primary/50 to-transparent"></div>
                        </div>
                    </div>
                    <p className="font-label text-xs tracking-widest text-outline uppercase opacity-60">Sistem Qeydiyyatı və İştirakçı siyahısı</p>
                </header>
